...
interface MultipleSelectorProps {
  ...
  options?: Option[]
  /** Optional add button label (shows at bottom if provided with onAddClick) */
  addButtonLabel?: string
  /** Click handler for add button (e.g. open dialog) */
  onAddClick?: () => void
  placeholder?: string
  /** Loading component. */
                ...
                <>
                  ...
                  <CommandGroup>
                    <CommandItem>
                      ...
                      >
                        <Plus className="mr-1 h-4 w-4" /> {addButtonLabel || "Add"}
                      </Button>
                    </CommandItem>
                  </CommandGroup>
                </>
